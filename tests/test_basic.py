"""Fixed basic tests for CallPyBack functionality."""
...
class TestCallPyBackBasics:
    ...
    def test_observer_priorities(self):
        ...
        high_priority = on_success(high_priority_callback, priority=100)
        low_priority = on_success(low_priority_callback, priority=1)
