...
class ProcessExecutor:
    ...
    def get_result(self, task_id: str, timeout: Optional[float] = None) -> ProcessResult:
    ...
    def wait_for_completion(self,
                          ...
                          timeout: Optional[float] = None) -> Dict[str, ProcessResult]:
