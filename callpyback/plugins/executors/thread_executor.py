...
class ThreadExecutor:
    ...
    def __init__(self,
        ...
        # Thread management
        self.executor = ThreadPoolExecutor(max_workers=max_workers, thread_name_prefix="CallPyBack-Thread")
        self.running = False
    ...
    def _dispatch_loop(self):
        ...
        while self.running:
            try:
                ...
                future.add_done_callback(lambda fut, tid=task.id: self._task_completed(tid, fut))
