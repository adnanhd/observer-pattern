...
class TopicRegistry:
    ...
    def __init__(self):
        ...
        self.subscribers: Dict[str, List[str]] = defaultdict(
            list
        )  # topic -> subscription_ids
    ...
    def register_topic(
        ...
        with self.lock:
            ...
            topic_info = TopicInfo(
                name=name, description=description, schema=schema, tags=tags or set()
            )
    ...
    def list_topics(
        self, tag: Optional[str] = None, pattern: Optional[str] = None
    ) -> List[TopicInfo]:
        """
